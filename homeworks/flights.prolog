...
% direct flights
route(Departing, Arriving, Visited, DepartureTime, ArrivalTime, Flight, Cost) :-
  	flight(Departing, Arriving, DepartureTime, ArrivalTime, Cost),
    not(member(Arriving, Visited)),
    Flight = [Departing, Arriving].

% connecting flights
route(Departing, Arriving, Visited, DepartureTime, ArrivalTime, Flights, TotalCost) :-
  flight(Departing, Connecting, DepartureTime, ConArrival, InitCost),
  not(member(Connecting, Visited)), 
  route(Connecting, Arriving, [Departing|[Connecting|Visited]], ConTime, ArrivalTime, TailFlight, RestCost),
  ConArrival @< ConTime,
  TotalCost is InitCost + RestCost,
  Flights = [Departing|TailFlight]. 
